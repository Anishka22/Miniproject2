...
request.setAttribute("list", list);
 %>
<h2 style="text-align: center;">MASALAS</h2><br>

<c:forEach items="${list }" var="product">
 						
 						<c:if test="${product.getCategory() == 'masala' }">
		 						...
		 						<a id="t"  href="Anishka?page=addtocart&action=masala&id=<c:out value="${product.getId()}"/>">Add to Cart</a>
		 						</figure>
