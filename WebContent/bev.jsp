...
<h2 style="text-align: center;">BEVERAGES</h2><br>

<c:forEach items="${list }" var="product">
 						
 						<c:if test="${product.getCategory() == 'bev' }">
		 						...
		 						<a id="t"  href="Anishka?page=addtocart&action=bev&id=<c:out value="${product.getId()}"/>">Add to Cart</a>
		 						</figure>
