...
request.setAttribute("list", list);
 %>
<h2 style="text-align: center;">CLEANING & HOUSEHOLD</h2><br>

<c:forEach items="${list }" var="product">
 						
 						<c:if test="${product.getCategory() == 'cl' }">
		 						...
		 						<a id="t"  href="Anishka?page=addtocart&action=cl&id=<c:out value="${product.getId()}"/>">Add to Cart</a>
		 						</figure>
