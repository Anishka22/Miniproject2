...
request.setAttribute("list", list);
 %>
<h2 style="text-align: center;">SNACKS & BRANDED FOOD</h2><br>

<c:forEach items="${list }" var="product">
 						
 						<c:if test="${product.getCategory() == 'choc' }">
		 						...
		 						<a id="t"  href="Anishka?page=addtocart&action=choc&id=<c:out value="${product.getId()}"/>">Add to Cart</a>
		 						</figure>
