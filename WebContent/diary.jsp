...
request.setAttribute("list", list);
 %>
<h2 style="text-align: center;">DAIRY</h2><br>

<c:forEach items="${list }" var="product">
 						
 						<c:if test="${product.getCategory() == 'diary' }">
		 						...
		 						<a id="t"  href="Anishka?page=addtocart&action=diary&id=<c:out value="${product.getId()}"/>">Add to Cart</a>
		 						</figure>
