...
request.setAttribute("list", list);
 %>
<h2 style="text-align: center;">EGG,MEAT & FISH</h2><br>

<c:forEach items="${list }" var="product">
 						
 						<c:if test="${product.getCategory() == 'eg' }">
		 						...
		 						<a id="t"  href="Anishka?page=addtocart&action=eg&id=<c:out value="${product.getId()}"/>">Add to Cart</a>
		 						</figure>
