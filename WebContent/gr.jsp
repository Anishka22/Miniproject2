...
request.setAttribute("list", list);
 %>
<h2 style="text-align: center;">GRAINS</h2><br>

<c:forEach items="${list }" var="product">
 						
 						<c:if test="${product.getCategory() == 'gr' }">
		 						...
		 						<a id="t"  href="Anishka?page=addtocart&action=gr&id=<c:out value="${product.getId()}"/>">Add to Cart</a>
		 						</figure>
